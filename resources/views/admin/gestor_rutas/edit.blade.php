            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea name="recomendaciones" rows="3"
                              class="form-control rounded-3 py-2"
                              placeholder="Ej. Llevar repelente, calzado adecuado...">{{ old('recomendaciones', $ruta->recomendaciones) }}</textarea>
                </div>
        ...
        <div class="p-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text"
                           value="{{ ucfirst($ruta->dificultad) }}"
                           class="form-control rounded-3 py-2 bg-light"
                           disabled>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text"
                           value="{{ $ruta->duracion_estimada ?? 'No especificada' }}"
                           class="form-control rounded-3 py-2 bg-light"
                           disabled>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text"
                           value="{{ $ruta->distancia_km ?? 'No especificada' }}"
                           class="form-control rounded-3 py-2 bg-light"
                           disabled>
                </div>
            ...
            <div class="d-flex flex-wrap gap-3">
                @foreach ($imagenes as $imagen)
                    <div class="position-relative" id="img-{{ $imagen->id_imagen }}">
                        <img src="{{ Storage::url($imagen->ruta_archivo) }}"
