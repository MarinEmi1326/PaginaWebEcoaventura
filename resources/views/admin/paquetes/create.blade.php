    ...
    <div class="ea-card p-4 mb-4">
        ...
        <div id="actividades-container">
            <div class="row g-3 mb-3 actividad-row">
                ...
                <div class="col-md-3">
                    <input type="number" name="actividades[0][minimo]" class="form-control" placeholder="Mínimo personas">
                </div>
                <div class="col-md-3">
                    <input type="number" name="actividades[0][maximo]" class="form-control" placeholder="Máximo personas">
                </div>
                <div class="col-md-1">
