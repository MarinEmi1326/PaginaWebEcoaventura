    ...
    <div class="d-flex flex-column flex-sm-row gap-2">
        <div style="min-width: 260px;">
            <div class="input-group">
                ...
                <input type="text" class="form-control border-start-0 rounded-end-3" placeholder="Buscar usuario...">
            </div>
        </div>
    ...
    @else
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <div class="d-inline-flex align-items-center gap-3">
                                    <a href="{{ route('admin.solicitudes.edit', $s->id_usuario) }}" class="text-decoration-none" style="color:#1e88e5;">
                                        <i class="bi bi-pencil-square me-1"></i> Editar
                                    </a>
                                    <a href="{{ route('admin.solicitudes.show', $s->id_usuario) }}" class="text-decoration-none" style="color: var(--ea-text);">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center px-3 px-md-4 py-3 border-top"
            ...
            <div class="d-flex align-items-center gap-2 mt-3 mt-md-0">
                ...
                <button class="btn btn-sm rounded-circle" style="width:32px; height:32px; background: var(--ea-green); color:#fff;">1</button>
                <button class="btn btn-sm border-0" style="color: var(--ea-text);">›</button>
            </div>
        </div>
    @endif
</div>
...
<div class="mt-4 d-flex justify-content-end">
    <a href="{{ route('admin.solicitudes.create') }}" class="btn ea-btn-green rounded-3 px-4 py-2 fw-semibold">
