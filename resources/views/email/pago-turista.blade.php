...
<head>
    <meta charset="UTF-8">
    <style>
        body { font-family: 'Inter', Arial, sans-serif; background:#f4f7f4; margin:0; padding:0; }
        ...
        .header { background:#1F6B4B; padding:32px 40px; text-align:center; }
        .header h1 { color:#fff; margin:0; font-size:22px; }
        .header p { color:#a8d5be; margin:8px 0 0; font-size:14px; }
        .body { padding:32px 40px; }
        .check { text-align:center; margin-bottom:24px; }
        .check-circle { display:inline-flex; align-items:center; justify-content:center; width:64px; height:64px; background:#e2ece9; border-radius:50%; font-size:32px; }
        h2 { color:#1a1a1a; font-size:20px; margin:0 0 8px; }
        p { color:#555; font-size:15px; line-height:1.6; margin:0 0 16px; }
        .card { background:#f7f9f7; border-radius:8px; padding:20px 24px; margin:24px 0; }
        .row { display:flex; justify-content:space-between; padding:8px 0; border-bottom:1px solid #e8ede9; }
        .row:last-child { border-bottom:none; }
        .label { color:#888; font-size:14px; }
        .value { color:#1a1a1a; font-size:14px; font-weight:600; }
        .total .value { color:#1F6B4B; font-size:16px; }
        .footer { background:#f7f9f7; padding:20px 40px; text-align:center; }
...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>Hola <strong>{{ $turista->nombre }}</strong>, tu reservación ha sido procesada exitosamente. Aquí está el resumen:</p>
            ...
            <div class="card">
                ...
                <div class="row">
                    <span class="label">Mínimo personas</span>
                    <span class="value">{{ $paquete->minimo_personas }}</span>
                </div>
                @endif
                <div class="row">
