                    ...
                    <div class="card-body px-4 pb-4" style="margin-top: -50px;">
                        ...
                        <form action="{{ route('perfil.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 mt-2">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-muted text-uppercase">Correo de
                                        Acceso</label>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <label class="form-label small fw-bold text-muted"><i class="bi bi-facebook me-1"></i>
                                        FACEBOOK URL</label>
                                    <input type="url" name="facebook_url" class="form-control border-0 shadow-sm py-2"
                                        placeholder="https://..."
                                        value="{{ old('facebook_url', auth()->user()->persona->facebook_url) }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label small fw-bold text-muted"><i class="bi bi-instagram me-1"></i>
                                        INSTAGRAM URL</label>
                                    <input type="url" name="instagram_url" class="form-control border-0 shadow-sm py-2"
                                        placeholder="https://..."
                                        value="{{ old('instagram_url', auth()->user()->persona->instagram_url) }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label small fw-bold text-muted"><i class="bi bi-tiktok me-1"></i>
                                        TIKTOK URL</label>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="password" name="password_confirmation"
                                        class="form-control border-0 shadow-sm py-2" placeholder="Confirmar Contraseña">
                                </div>
                            </div>
